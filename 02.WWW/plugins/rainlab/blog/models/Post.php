...
class Post extends Model
{
    ...
    public static function getPostHomepage($order_by = null)
    {
        if($order_by)
            return self::where('published',1)->orderBy($order_by,'DESC')->first();
        else
            return self::where('published',1)->orderBy('id','DESC')->first();
    }
}
